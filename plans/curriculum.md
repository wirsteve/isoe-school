...
| `blood-center-operations` | 1 / 5 | In progress |
...
**Next up:** `blood-center-operations` (Track 1), module 2: `collection-and-testing`. See
`plans/blood-center-operations.md` for the full module list and scoping decisions.
