...
**Site:** `https://<github-username>.github.io/isoe-school/`

## What to type at claude.ai/code (with this repo selected)

- Start a course: `Create a course: I want to be able to <finish line>`
- Keep going: `Continue the course`
...
| `plans/` | One plan and progress file per course, which carries state between sessions |
